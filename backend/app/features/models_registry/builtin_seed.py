...
BUILTIN_MODEL_PROFILE_SEEDS: tuple[BuiltinModelProfileSeed, ...] = (
    ...
    BuiltinModelProfileSeed(
        ...
        timeout_seconds=300,
        pricing_input_per_million=Decimal("3.0000"),
        pricing_output_per_million=Decimal("15.0000"),
        notes="Anthropic Claude Sonnet native endpoint.",
    ),
    BuiltinModelProfileSeed(
        ...
        timeout_seconds=300,
        pricing_input_per_million=Decimal("15.0000"),
        pricing_output_per_million=Decimal("75.0000"),
        notes="Anthropic Claude Opus native endpoint.",
    ),
    BuiltinModelProfileSeed(
